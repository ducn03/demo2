    ...
    function (isConfirm) {
      if (isConfirm) {
        swal({
          title: ":3",
          text:
            "Chúc chị Thư tuổi mới tràn đầy niềm vui và những khoảnh khắc đáng nhớ, sức khỏe dồi dào và gặp nhiều may mắn trong cuộc sống. Mong rằng những mong muốn và kế hoạch của chị Thư đều được hoàn thành một cách suôn sẻ. Cuối cùng thì em muốn xin lỗi vì những gì mình đã nói và làm, không cầu mong sự tha thứ nhưng mà cho phép em nói HAPPY BIRTHDAY!",
          type: "success"
        });
      }
    });
